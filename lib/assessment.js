...
var evenp = function(currentValue) {
  return (currentValue % 2) === 0;
};

var oddp = function(currentValue) {
  return (currentValue % 2) === 1;
};

var greaterThanZeroP = function(currentValue) {
  return (currentValue % 2) === 1;
};


console.log('even?', find(numbers, evenp));


console.log('odd?', find(numbers, oddp));


console.log('> 0 ?', find(numbers, greaterThanZeroP));
