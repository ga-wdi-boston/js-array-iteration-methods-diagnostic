...
let i =0;
let minimum = previous.reduce(i++,previous,[0],current);
};
...
const first = function (previous, current) {

  previous.prototype.current = function () {

    let new previous = current.filter(previous[0]);
  };
