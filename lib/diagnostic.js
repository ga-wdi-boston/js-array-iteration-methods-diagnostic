...
const min = function (previous, current) {
  ...
  // What are previous and current? Indecies of an array? What array?
  // I can't find my examples of callbacks from yesterday, I am not sure
  // how to use callback functions.

  let arr = []; // since the min function does not take an array parameter
  let minimum = 0; // I don't think I'm going to return this since I'm using
  // callbacks, but I don't know how.
