...
//I did not comprehend anything from the morning training yesterday, except
//that the callback has some boilerplate elements that are used when called.
//I am not going to try to copy and paste something I do not understand.
//This does not help me learn.

//Why don't we review the answers to this diagnostic
//with the entire class, because I can't believe others would not benefit from this.
// Apologies for the rant, but I have had zero sleep, and am not feeling well.
