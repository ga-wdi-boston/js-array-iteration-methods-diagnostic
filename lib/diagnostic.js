...
const min = function (array, callback) {
  const minimum = Math.min[array] // array.reduce(callback)
  return minimum
}
//min([-1, -2, -3, -4, -5], callback(e, i, a))
...
const sum = function (array, callback) {
  const total = array.reduce(callback(e, i, a))
  return total
}
...
const result = hasNone([false, false], (e, i, a) => i >= 0)
